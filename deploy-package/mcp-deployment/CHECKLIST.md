...
## 6. Webhook Setup
- [x] Add webhook route: `/webhooks/webhook`.
- [x] In external service, set URL: `https://mcp.engineerstechbd.com/webhooks/webhook`.
- [x] Add signature verification logic in code.

## 7. Quick Bootstrap Setup (new)
- [x] Open URL: `https://mcp.engineerstechbd.com/setup` to operate the setup UI.
- [x] Or call API:
  - `POST /setup` with JSON: `{ "email":"admin@engineerstechbd.com", "role":"admin" }`
- [x] It creates first admin user + stores OpenRouter settings from env.
